...
> 评审材料，保留原作者的判断与提问。文中的旧文档路径、章节和行号对应整理前的版本：
> [原 VM 文档](../history/2026-09-21/docs/04-lain-vm.md)、
> [原 AGENTS](../history/2026-09-21/AGENTS.md)。
> 现行规则从 [VM 契约](../spec/vm.md) 和 [开发约定](../spec/development.md) 阅读。
