...
CHECKS = (
    ...
    ("frontend operator precedence", "check_operator_precedence.py"),
    ("ordinary condition expression lowering", "check_condition_expression_lowering.py"),
    ("lexical local and parameter assignments", "check_local_assignment_types.py", "--deterministic", "--check-scope-errors"),
    ...
    ("type expression terminal", "check_type_expression_end.py"),
    ("constant namespace scopes", "check_constant_scopes.py"),
    ("compiler artifact physical verification", "check_compiler_artifact_verification.py"),
